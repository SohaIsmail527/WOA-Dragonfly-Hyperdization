...
# DA Function
def dragonfly_algorithm(size = 3, min_values = [-5,-5], max_values = [5,5], generations = 50, target_function = target_function, verbose = True, start_init = None, target_value = None):
    min_values  = np.array(min_values)
    max_values  = np.array(max_values) 
    delta_max   = (max_values - min_values) / 10
    food_pos    = initial_variables(1,    min_values, max_values, target_function, start_init)
